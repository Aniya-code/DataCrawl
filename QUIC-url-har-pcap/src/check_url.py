    ...
    for idx, row in enumerate(rows):
        ...
        for info_row in url_info:
            if info_row['url'] == row[0]:
                ...
                break
        if duration <= 60 or duration >= 1800: # 滤掉小于1分钟，大于30分钟的url
...
input_file = r'data\url\funtv8964_url_202406051751.csv'
output_file = r'data\url\final_funtv8964_url_202406051751.csv'
url_info_path = r'data\url_info\funtv_url_info.csv'
