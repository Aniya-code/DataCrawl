...
#####################################################
input_url_path = r'data\funtv8964_urll_202406051751.csv'
url_info_path = r'data\url_infocsv'
#####################################################
...
with open(url_info_path, '+a', newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
    writer.writerow(["date","url","duration","resolution","video_itag","video_contentlength","video_bitrate","audio_itag","audio_contentlength","audio_bitrate"])
